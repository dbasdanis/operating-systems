...
struct task_struct
{
	...
	long double start_running_time;		//time that the process gets in cpu
	long double last_burst;                               
	long double exp_burst;              //expected burst  
	long double last_run_time;        	//last time that left the cpu or that entered the runqueue	  
